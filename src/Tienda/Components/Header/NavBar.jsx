...
export const NavBar = () => {
  ...
  const handleUpdate=()=>{
    setProduct(document.querySelector('#search').value)
    }
  let activeStyle = {
    background: '#198754', 
    color:'white',
    ...
    <>
      ...
      >
        ...
        <div className="container d-flex align-items-center h-16 justify-content-between px-0  ">
            ...
            {/* buscador */}
            <div className="input-group w-50 d-none d-md-flex position-relative ">
              <input
                type="search"
                ...
                style={{ widht: "100px" }}
              />
              <button className="btn btn-light btn-search py-0">
                <svg
              ...
              <div className="position-absolute search w-100 bg-light " >
                {
                  product.length>2 ? <Search prod={product} />: ""
                }
